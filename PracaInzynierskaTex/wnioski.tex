...
\begin{figure}[!ht]
	\centering{\includegraphics{datasets/v4a6c5l5-light.png}}
...
\begin{figure}[!ht]
	\centering{\includegraphics[scale=0.34]{examples/v4a6c5l5.csv_run-686_21_3_21_184242_35664_645567/graphviz.png}}
	\caption{\label{fig:p1_model}Znaleziony model -- przykład ze wstępu}
\end{figure}

Do znalezienia modelu potrzebne było 179 generacji, podczas których przeszukano 47615 unikalnych osobników. Zajęło to 11.3 minuty, używając 1 wątku procesora. Natomiast, metryki mają następujące wartości: 
...
\begin{figure}[!ht]
	\centering{\includegraphics[scale=0.85]{examples/v4a6c5l5.csv_run-648_21_4_23_005638_10340_1/result_graph.pdf}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.8]{datasets/v8a5c40l5-light.png}}
...
Do znalezienia modelu potrzebne było 5 generacji, podczas których przeszukano 2369 unikalnych osobników. Zajęło to 66.5 sekund, używając 4 wątków procesora. Natomiast, metryki mają następujące wartości: 
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.83]{examples/v8a5c40l5.csv_run-24_21_3_6_211037_47336_515221/result_graph.pdf}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.27]{examples/v12a11c3512l9.csv_run-10231_21_3_1_042344_29708_523416/graphviz.png}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.7]{examples/v12a11c3512l9.csv_run-10231_21_3_1_042344_29708_523416/result_graph.pdf}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.85]{datasets/v45a7c1000l14.png}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.5]{examples/v45a7c1000l14.csv_run-1366_21_3_6_143708_2144_563150/graphviz.png}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.85]{examples/v45a7c1000l14.csv_run-1366_21_3_6_143708_2144_563150/result_graph.pdf}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.87]{datasets/v21a81391l17.png}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.39]{examples/v21a81391l17.csv_run-15614_21_3_1_225455/graphviz.png}}
	\caption{\label{fig:p5_model}Znaleziony model -- przykład \#Obsługa wniosku o odszkodowanie}
\end{figure}

Do znalezienia modelu potrzebne było 685 generacji. Zajęło to 4.1 godziny, używając 1 wątku procesora. Natomiast, metryki mają następujące wartości: 
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.83]{examples/v21a81391l17.csv_21_4_13_201133_15092_996333/result_graph.pdf}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.85]{datasets/v846a16c1050l185-light.png}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.83]{examples/v846a16c1050l185.csv_run-61_21_4_23_001933_1768_571571/result_graph.pdf}}
...
\begin{figure}[!ht]
	\centering{\includegraphics[scale=0.8]{datasets/v8a7c1254l5-light.png}}
...
Do znalezienia modelu potrzebne były 233 generacje, podczas których przeszukano 41537 unikalnych osobników. Zajęło to 8.4 minuty, używając 4 wątków procesora. Natomiast, metryki mają następujące wartości: 
...
\begin{figure}[!ht]
	\centering{\includegraphics[scale=0.37]{examples/v8a7c1254l5.csv_21_4_13_211038_8672_3/graphviz.png}}
...
Poniżej zaprezentowano średnią ważoną, gdyby przyjąć wagi metryk z poprawnego modelu, a także wartości poszczególnych metryk. 
 \begin{center}
  \begin{tabular}{l}
...
Poniżej zaprezentowano średnią ważoną, gdyby przyjąć wagi metryk z poprawnego modelu, a także wartości poszczególnych metryk. Co ciekawe, wartość generalizacji wciąż nie jest dużo niższa niż w~poprawnym modelu.
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.4]{time_average.png}}
...
\begin{figure}[H]
	\centering{\includegraphics[scale=0.48]{complexity-summary.png}}
