...
Zapis GE{\_}RANGE:dataset{\_}n{\_}vars jest rozszerzenie do gramatyki zapewnianym przez PonyGE2, ktore umożliwia dodanie ilosci zmiennych odpowiadajacej ich ilosci w zbiorze danych.
\begin{figure}[!ht]
...
<lopgate> ::= lop(<anygatenosinglelop>)

<anygatenosinglelop> ::= <anygateexceptseq><anygateexceptseq> | <andgate> | 
<xorgate> | <seqgate> | <optdoublegate> | {<event>}

<event> ::= GE_RANGE:dataset_n_vars
\end{lstlisting}
\end{figure}
