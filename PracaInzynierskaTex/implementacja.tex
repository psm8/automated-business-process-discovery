...
\begin{itemize}
    \item wrappers - PonyGE2 nie jest przystosowane do zaimportowania jako biblioteka, dlatego żeby oddzielić kod PonyGE2 od naszego kodu należało rozszerzyć lub nadpisać cześć z modułów PonyGE2. Także w tym modele znajdują się rozszerzenia do PonyGE2 dodające nowe funkcjonalności.
  \item fitness{\_}functions - bazowy moduł, gdzie znajduje się klasa dla obliczania dopasowania, która korzysta z metod w module process{\_}discovery.
